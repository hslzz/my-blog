...
7.2 本站文章均采用国际通用**CC BY-NC-SA 4.0协议**。您可以**以基于CC BY-NC-SA 4.0协议且非商业性质为目的**的转载本站文章或使用进行二次创作，但**必须进行署名**，署名需包含原文标题、作者（花生莲子粥）及本站相关文章链接。（注：以“基于CC BY-NC-SA 4.0协议转载或二创本站文章意思指：基于本站文章转载或二创后的文章也必须是基于CC BY-NC-SA 4.0协议。）
