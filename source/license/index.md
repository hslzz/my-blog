...
1.3 本站：指由站长负责维护运营的《花生莲子粥の小窝》博客网站（网络域名：blog.hslzz.cn，且该主域名旗下子域如hslzz.cn，*.hslzz.cn也适用于本协议）、APP、社交平台等，**以下简称“本站”**。包括现有的及未来发布的任何版本（含客户端软件、服务器端软件、源代码、目标代码、资源文件等）；包括相关网络服务器、官方网站、电子媒体、印刷材料等。
...
3.4.6 其他违反互联网行业公认的准则或违背公序良俗的行为。
...
4.2 站长享有本站所有原创文章一切合法权利。本站刊载的一切非原创内容中其作者享有一切合法权利。
...
5.3 使用评论系统时，您的省级 IP 地址和浏览器信息将公开，仅用于安全防护及合规审查。
...
5.7 由于评论系统的特殊性，您发表评论后仅站长有删除评论的权限。您在发表评论后联系站长删除评论，在站长删除评论前未造成不良后果的，由站长自行决定是否可以免除责任。

5.8 您清楚的认识到，评论中展示的所有内容均不代表本站及站长立场，由于评论系统的特殊性，获取了邮箱即可以伪造其他人发出的评论。因此所有人包括站长发布的评论均不代表本站任何立场。请勿轻信未经验证的评论内容。用户可通过联系站长hi@hslzz.cn核实评论真实性。
...
- （1）您的网站已经添加本站友链，本站不接受单向友链请求。（2）您的网站属于非商业性质（注：如要求关注公众号、下载 App 后浏览文章等阅读拦截行为也将被视为商业性质站点）。
- （3）您的网站符合中华人民共和国法律法规的要求。
- （4）您的网站应当稳定，主屏能在一分钟之内全部加载完毕，且域名并非us.kg之类的免费域名。但github.io、gitee.io除外
- （5）同意本站的服务协议。

6.2 若您的站点刊载了违法违规内容、违背公序良俗的内容、不符合本站协议的内容的，经核实后站长有权撤销您在本站的友情链接且保留自主决定是否通知您的权利。

6.3 若您的网站无法访问或者将本站友情链接单方面撤销的，本站有权撤销您在本站的友情链接且保留自主决定是否通知您的权利。

6.4 本站友情链接指向的网站并非站长实控，本站友情链接指向的网站刊载的所有内容，除转载或二次创作的本站原创文章以外，均和本站无实质关系。

6.5 本站不对友情链接指向的网站刊载的内容导致的一切责任负责，请您自行斟酌。

6.7 若您发现本站友情链接指向的任意站点存在违法违规内容或不符合本站协议内容的，您可通过站长邮箱hi@hslzz.cn向站长提交反馈，核实后将会处理。
...
7.2 本站文章均采用国际通用**CC BY-NC-SA 4.0协议**。您可以**以基于CC BY-NC-SA 4.0协议且非商业性质为目的**的转载本站文章或使用进行二次创作，但**必须进行署名**，署名需包含原文标题、作者（花生莲子粥）及本站相关文章链接。

7.3 您不得将本站文章用于商业性质使用（注：如要求关注公众号、下载 App 后浏览文章等**阅读拦截行为**也将被视为商业性质站点）。**不得擅自或授权第三方进行任何出版、商业盈利及其他商业使用的行为。如违反本条约定，站长将保留法律上的追诉权利。**
...
9.3 **若您和本站之间因本协议发生任何纠纷或争议，首先应友好协商解决，协商不成的，您同意将纠纷或争议提交至本协议签订地（福建省三明市永安市）有管辖权的人民法院管辖。诉讼产生的合理费用（如律师费、公证费）由败诉方承担**
...
10.5 本站依托第三方工具（如Twikoo、WeAvatar，Hexo框架、Butterfly主题等）提供服务，若是因为站长用以搭建本站的工具存在漏洞、病毒、BUG等工具导致的原因致使您的权益受损，站长不承担任何责任，用户应向相关工具提供方（如GitHub、WeAvatar官方）维权。

10.6 本站尽可能的保护您在本站留存的所有信息，但因黑客等站长现有的网络技术无法抗衡的行为导致您的信息泄露，请向作恶方维权，本站不承担责任，请自行做好信息保护。

10.7 因用户误操作导致的损失，本站不承担责任，造成本站损失的，用户需承担所有责任。
