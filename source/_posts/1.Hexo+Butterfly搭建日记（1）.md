---
title: 【Hexo】Hexo + Butterflyの安装过程
...
由于 Node 和 npm 是在一起的，安装了 Node 同时也会安装/更新 npm ，一举两得。
...
博客根目录文件夹可以改为任意名字，每个人都可能不一样，下文将统称为**{blogroot}文件夹**
...
后续对butterfly主题的美化配置就在**__config.butterfly.yml_**进行修改就可以了~
...
在汉化标注过的配置文件中，你可以快速了解到所有配置的注解，让你配置文件更加方便。 
